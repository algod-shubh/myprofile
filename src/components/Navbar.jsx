...
import { logo, menu, close, shubham_logo } from "../assets";
...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex-item-s-center py-5 fixed top-0 z-20 bg-primary`}
    >
      <div className="w full flex justify-between items-centre max-w-7x1 mx-auto">
        ...
        >
          ...
          {navLinks.map((link, idx) => (
            <li
              ...
              } hover:text-white font-poppins font-medium 
        ...
        : 'flex'} p-6 black-gradient absolute top-20 mx-4 my-2 min-w-[140px]
        z-10 rounded: x1`}>
