...
const experiences = [
  {
    ...
    points: [
      ...
      "Implemented the My Account section of the website and used various backend APIS to display real-time content",
      "Participating in code reviews and providing constructive feedback to other developers.",
    ],
  },
  {
    title: "Software Developer Intern",
    company_name: "Profound Tech",
    icon: profound_tech,
    iconBg: "#fff",
...
const testimonials = [
  ...
  },
  {
    ...
    name: "Chris Brown",
    designation: "CEO",
    company: "ProfoundTech Solutions",
